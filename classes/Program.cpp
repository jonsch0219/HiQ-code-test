...
void Program::runProgram() {
    ...
    while(room_size.empty()) // Loop until valid room size is inputted by user
    ...
    while (true) { // Loop until valid start position and direction is inputted from user
    ...
    while (commands.empty()) //Loop until valid commands are inputted by user
